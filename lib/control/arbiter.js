 ...
 * arbiter never has to know about the pump or the emergency valve.
 */
 ...
 *
 * @param {{ points: ioBroker.AerationPointConfig[], groups: ioBroker.AerationGroupConfig[], schedules: ioBroker.AerationScheduleConfig[], masterEnable: boolean, mode: string, manual: boolean[], groupActive: boolean[], roundRobinEnabled: boolean, roundRobinOrder: number[], roundRobinDwellSec: number, nowDay: number, nowMinutes: number, elapsedMs: number }} ctx - the control context
